...
import torch
import util
from tgb_model import TGBModel
...
parser.add_argument('--out_dim', type=int, default=1, help='out dimension')
parser.add_argument('--num_nodes', type=int, default=255,
...
def main():
    ...
    engine = TGBModel(scaler, args.num_nodes, args.in_dim, args.out_dim, args.timesteps, args.learning_rate,
